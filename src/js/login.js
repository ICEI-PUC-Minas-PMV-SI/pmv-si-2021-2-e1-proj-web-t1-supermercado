...
const HOME_URL = "../html/index.html";
const ADMIN_URL = "../html/admin.html"
...
function addUser(nome, login, senha, email, botao) {

    // Cria um objeto de usuario para o novo usuario 
    let newId = generateUUID();
    let usuario = {
        "id": newId, "login": login, "senha": senha, "nome": nome, "email": email, "botao": botao
    };
